<template>
  <div class="emotional">
      ...
      <el-table :data="tableData" style="width:100%">
        ...
        <el-table-column prop="dairyData"  label="记录日期"  width="120" />
        <el-table-column label="情绪评分" >
             <template #default="scope">
                   <el-avatar :model="scope.row.moodScore" :max="10" disabled/>
             </template>
        </el-table-column>
        ...
        <el-table-column prop="dairyContent" label="日记内容" width="250" />
        <el-table-column  label="操作"  width="240"  fixed="right" >
            <template #default="scope">
                   <el-button @click="viewSessionDetail(scope.row)" text type="primary" >详细</el-button>
               ...
               <div class="detail-content" v-if="currentDetail">
                  <div class="detail-section">
                      ...
                      <el-descriptions :column="2" border > 
                          ...
                          <el-descriptions-item label="记录日期">{{ currentDetail.dairyData }}</el-descriptions-item>
                      </el-descriptions>
                  </div> 
                  <div class="detail-section">
                      <h4>情绪状态</h4>
                  ...
                  <div class="detail-section">
                    ...
                    <el-descriptions :column="1" border >
                      ...
                      <el-descriptions-item label="日记内容">{{ currentDetail.dairyContent || '-' }}</el-descriptions-item>
                    </el-descriptions>
                  </div>
                  <div class="detail-section">
                    <h4>AI情绪分析结果</h4>
                    ...
                    <div class="ai-suggestion-section">
                      <h5>专业建议</h5>
                      <div class="suggestion-content">{{ aiData.suggestions || '-' }}</div>
                    </div>
                    <div class="ai-risk-section">
                      <h5>风险等级</h5>
                      <div class="risk-content">{{ getRiskLevelText(aiData.riskDescription) }}</div>
                    </div>
                    <div class="ai-improvements-section">
                      <h5>改善建议</h5>
                      <ul class="improvements-list">
                        <li v-for="item in aiData.improveSuggestions" :key="item">{{ item }}</li>
                      </ul>
                    </div>
                    </div>                    
                  </div>
