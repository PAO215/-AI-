        ...
        <div class="content">
            ...
            <div class="diary-card">
                ...
                <div class="emotion-grid">
                    <div class="emotion-card" v-for="emotion in emotionOptions" :key="emotion.name" :class="{'selected' :emotion.name===diaryForm.dominantEmotion}" @click="selectEmotion(emotion.name)">
            ...
            <div class="diary-card">
                ...
                <div class="detail-form">
                    <div class="form-group">
                        <div class="form-label">情绪诱发因素</div>
                        <el-input v-model="diaryForm.emotionTriggers" placeholder="今天发生了什么事情影响你的情绪？" type="textarea" :rows="3" maxlength="1000" show-word-limit></el-input>
                    </div>
                    <div class="form-group">
                        <div class="form-label">今日感想</div>
                        <el-input v-model="diaryForm.diaryContent" placeholder="写下今天的想法、感受或发生的有趣事情..." type="textarea" :rows="5" maxlength="2000" show-word-limit></el-input>
                    </div>
                    <!---生活指标-->
