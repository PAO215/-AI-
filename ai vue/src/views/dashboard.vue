        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
              ...
              <div class="info"> 
                ...
                <p class="number">{{aiData.systemOverview.averageEmotion}}</p>
                <p class="subtitle-title">情绪健康指数：{{aiData.systemOverview.emotionHealthIndex}}/10</p> 
              </div>    
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :span="12">
        <el-card style="width:100%" >
          ...
          <div class="chart-content">
            <div ref="emotionChartRef" style="width: 100%; height: 100%;"></div>
          </div>
        </el-card>
